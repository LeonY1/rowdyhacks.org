...
const AboutTextBlock1: string = "It's a great opportunity to network, meet new people, and build your connnections";
...
const FAQAnswers: Array<any> = [
	...
	'Sorry, but RowdyHacks will not be offering travel reimbursements for this hackathon.',
...
const SocialMediaText: string = 'For live updates and announcements, follow us on social media!';
